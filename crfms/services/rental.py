...
class RentalService:
    """ Coordinates use cases for picking up and returning vehicles,extending rentals, and computing charges. """
    def __init__(
        self,
        db: Database,
        clock: Clock,
    ...
    def pickup_vehicle(
        ...
        """ Performs an idempotent pickup, creating a rental agreement. """
    ...
    def return_vehicle(
        ...
        """ Performs an idempotent return, computing charges and creating an invoice. """
    ...
    def extend_rental(self, agreement_id: UUID, new_due_time: datetime) -> bool:
        """Extends a rental, checking for conflicts."""
        agreement = self.db.rental_agreements[agreement_id]
